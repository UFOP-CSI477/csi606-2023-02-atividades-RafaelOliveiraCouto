...
interface DeleteCidadesParamsInterface {
    params: {
        id: string
    }
}

export default function DeleteCidades( {params} : DeleteCidadesParamsInterface ){
    ...
    return(
        <main className="container m-auto mt-10">
            <h1 className="text-3xl font-bold mb-6">Exclusão da Ciade: {nome}-{estadoId}</h1>
